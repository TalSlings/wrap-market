...
const NOTE_SECTIONS = [
  ...
  ["color_pattern_single_color", "תכונת צבע — צבע יחיד"],
  ["color_pattern_two_color_positive_negative", "תכונת צבע — שני צבעים / נגטיב"],
  ["color_pattern_stripes_ombre_symmetric", "תכונת צבע — פסים או אומברה סימטריים"],
  ["color_pattern_stripes_ombre_asymmetric", "תכונת צבע — פסים או אומברה לא סימטריים"],
